...
CREATE TABLE BOOK (BOOK_ID INTEGER IDENTITY, ISBN VARCHAR(13) NOT NULL, TITLE VARCHAR(255) NOT NULL, PICTURE BLOB)
CREATE TABLE AUTHOR (AUTHOR_ID INTEGER IDENTITY, NAME VARCHAR(255) NOT NULL)
...
CREATE TABLE CATEGORY (CATEGORY_ID INTEGER IDENTITY, NAME VARCHAR(255) NOT NULL)
...
CREATE TABLE FILENAME (FILENAME_ID INTEGER IDENTITY, NAME VARCHAR(255) NOT NULL, BOOK_ID INTEGER NOT NULL, FOREIGN KEY (BOOK_ID) REFERENCES BOOK(BOOK_ID))
